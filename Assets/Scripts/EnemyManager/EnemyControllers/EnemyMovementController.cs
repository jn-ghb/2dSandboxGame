...
public class EnemyMovementController
{
    ...
    //ノックバック
    public void KnockBack(string direction, float knockBackUpForce, float knockBackHorizontalForce)
    {
        _knockBackUpForce = knockBackUpForce;
        _knockBackHorizontalForce = knockBackHorizontalForce;
        _direction = direction;
        _rigidbody2D.velocity = new Vector2(0, 0);
